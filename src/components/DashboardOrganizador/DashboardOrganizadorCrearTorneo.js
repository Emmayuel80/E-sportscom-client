...
const DashboardOrganizadorCrearTorneo = () => {
  ...
  const handleChange = (prop) => (event) => {
    ...
    if (prop === "idJuego") {
      setValues({
        ...values,
        idJuego: event.target.value,
        noEquipos: event.target.value === "1" ? 4 : 8,
      });
    }
  };
      ...
      <PublicForm pady={10} minWidth={"80%"}>
          ...
          <FormControl fullWidth>
            <Grid sx={{ py: 2, px: 1 }} item xs={12} md={12} lg={12}>
              <TextField
                ...
                onChange={handleChange("nombreTorneo")}
              ></TextField>
            </Grid>
          </FormControl>
        </Grid>
              ...
              <Grid sx={{ py: 2, px: 1 }} item xs={12} md={12} lg={12}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    labelId="equipos-select"
                    value={
                      values.noEquipos < 8 && values.idJuego === "2"
                        ? 8
                        : values.noEquipos
                    }
        ...
        {values.premio && (
          <Grid sx={{ py: 2, px: 1 }} item xs={12} md={12} lg={12}>
            <TextField
              ...
              onChange={handleChange("descPremio")}
            ></TextField>
          </Grid>
        )}
        <Grid sx={{ py: 2, px: 1 }} item xs={12} md={6} lg={6}>
        ...
        <Grid sx={{ py: 2, px: 1 }} item xs={12} md={12} lg={12}>
          <TextField
            ...
            onChange={handleChange("descTorneo")}
          ></TextField>
        </Grid>
